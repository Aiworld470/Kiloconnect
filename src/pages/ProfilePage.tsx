...
import { MapPin, Calendar, Package, Mail, Phone, Globe, Edit, Star, MessageSquare, Clock, ChevronRight, Plane } from 'lucide-react';
        ...
        <div className="md:col-span-1">
          <div className="card overflow-hidden">
            ...
            <div className="-mt-12 px-6 pb-6">
              ...
              <h2 className="mb-1 mt-3 text-xl font-bold">{profileUser.name}</h2>
        ...
        <div className="md:col-span-2">
          ...
          <div className="mb-6 border-b border-gray-200">
            <nav className="flex space-x-8">
              {[
                { id: 'trips', label: 'Trajets', icon: <Plane size={18} /> },
